<?php
        ...
        if($tipo_sistema_fotos==4)
        {
          ...
          copy($_FILES['Filedata']['tmp_name'], $caminho."/" . $nome_sistema_fotos . "/thumbs/" . $codigo_registro . "." . $tipo_arquivo_grande); 
          ...
          if($redimensionamento_automatico!=0)
          {
            ...
            $caminho_arquivo_original = $caminho . "/" . $nome_sistema_fotos . "/thumbs/" . $codigo_registro . "." . $tipo_arquivo_grande;
