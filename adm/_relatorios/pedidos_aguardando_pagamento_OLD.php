<?php
  ...
  $sql = " SELECT DISTINCT(p.codigo_pedido), descricao_tipo_envio, descricao_forma_de_pagamento, p.numero_pedido, p.valor_pedido, p.codigo_cliente, p.codigo_situacao, p.session, p.data_pedido, p.codigo_endereco, p.valor_frete, p.valor_total, ";
  ...
  $sql.= " FROM tabela_ec_pedidos_detalhes p, tabela_ec_pedidos_itens i, tabela_ec_clientes_enderecos en, tabela_ec_clientes_detalhes c, tabela_ec_pedidos_situacoes sp, tabela_ec_tipos_envio, tabela_ec_formas_de_pagamento";
  $sql.= " WHERE ";
