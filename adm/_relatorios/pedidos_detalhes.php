<?php
  ...
  $nome_relatorio = "Pedidos - Detalhes";


  // Campos do Grupo e Itens

  $sql = " SELECT p.codigo_pedido, p.valor_pedido, p.numero_pedido, p.valor_pedido, p.codigo_cliente, p.session, p.data_pedido, p.valor_frete, p.valor_total, ";
  $sql.= " pi.codigo_item, pi.descricao_item, pi.quantidade, pi.valor_unitario, ";
  $sql.= " referencia_produto, descricao_situacao, ";
  ...
  $sql.= " FROM tabela_ec_pedidos_detalhes p, tabela_ec_pedidos_itens pi, tabela_ec_clientes_enderecos en, tabela_ec_clientes_detalhes c, tabela_ec_produtos_detalhes, tabela_ec_pedidos_situacoes ps";
  ...
  $sql.= " AND p.codigo_situacao = ps.codigo_situacao "; 
  ...
  $campos[151] = "valor_pedido,valor_frete,valor_total";
  $campos[152] = "Valor do Pedido / Frete / Total";
  $campos[153] = "moeda,moeda,moeda";
  $campos[154] = "tabela_ec_pedidos_detalhes";
  $campos[155] = "15%";
  $campos[156] = "<br />";

  $campos[161] = "descricao_situacao";
  $campos[162] = "Status";
  $campos[163] = "varchar";
  $campos[164] = "tabela_ec_pedidos_situacoes";
  $campos[165] = "15%";
  $campos[166] = "<br />";

  // $campos[171] = "nome_usuario";
  // $campos[172] = "Funcion�rio";
  // $campos[173] = "varchar";
  // $campos[174] = "tabela_adm_usuarios";
  // $campos[175] = "15%";
  // $campos[176] = " - ";
  ...
  {	
    ...
    {	 
      ...
      if($k>1)
      {
        if($numero_campos_item>0)
        {
          ...
          // ##########################################################################
          echo "<br /><font class=relatorio>Total de itens: ".$total_itens."</font><br /><br />";
          $total_itens=0;
          // ##########################################################################
      ...
      // echo '<tr><td td colspan=' . $numero_campos . ' bgcolor="#eeeeee"><a href="../ec_pedidos_detalhes/editar_dados.php?codigo_pedido='.$linha['codigo_pedido'].'" class=relatorio style="font-size: 20px; font-weight: bold; float: right; color: red;">[editar pedido]</a></td></tr>';

      echo "<tr><td colspan=" . $numero_campos . " bgcolor='#eeeeee' wid>";
      echo "<b><font class=relatorio>Endere�o de entrega: </b>$descricao_endereco";
      //echo '<a href="../ec_pedidos_detalhes/editar_dados.php?codigo_pedido='.$linha['codigo_pedido'].'" class=relatorio style="font-size: 16px; font-weight: bold; float: right;">[editar pedido]</a>';
      echo '<a href="../_modulos/editar_dados.php?codigo_modulo=15&codigo_pedido='.$linha['codigo_pedido'].'" class=relatorio style="font-size: 16px; font-weight: bold; float: right;">[editar pedido]</a>';
      echo '</td></tr>';
    ...
    else
    {
     ...
     // ##########################################################################
     echo "<font class=relatorio style='float:left;'>Total de �tens: ".$total_itens."</font>";
     $total_itens=0;
     // ##########################################################################
