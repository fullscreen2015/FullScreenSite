<?php
  ...
  $sql = "SELECT tabela_ec_pedidos_detalhes.* , email_cliente";
  $sql .= " FROM tabela_ec_produtos_detalhes, tabela_ec_pedidos_detalhes, tabela_ec_clientes_detalhes";
  $sql.= " WHERE tabela_ec_pedidos_detalhes.codigo_cliente=tabela_ec_clientes_detalhes.codigo_cliente ";
  $sql .= " AND tabela_ec_pedidos_detalhes.codigo_pedido=tabela_ec_pedidos_detalhes.codigo_pedido ";
  $sql .= " AND tabela_ec_pedidos_detalhes.codigo_situacao=2 ";
  $sql .= " AND tabela_ec_pedidos_detalhes.codigo_forma_de_pagamento=4";
  $sql .= " AND tabela_ec_pedidos_detalhes.data_pedido < (now() - INTERVAL 3 DAY)";
