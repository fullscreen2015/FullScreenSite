<?php
  ...
  $sql = " SELECT codigo_pedido, numero_pedido, valor_pedido, data_pedido, ";
  $sql.= " nome_cliente, email_cliente ";
  $sql.= " FROM tabela_ec_pedidos_detalhes";
  $sql.= " , tabela_ec_clientes_detalhes";
  $sql.= " WHERE codigo_situacao = 1 ";
  $sql.= " AND tabela_ec_pedidos_detalhes.codigo_cliente = tabela_ec_clientes_detalhes.codigo_cliente";
  $sql.= " AND tabela_ec_pedidos_detalhes.ativo = 1 ";
  $sql.= " ORDER BY codigo_pedido DESC";
  ...
  $sql_item = " SELECT pi.codigo_item, pi.descricao_item,pi.codigo_pedido,pi.quantidade,pi.valor_unitario";
