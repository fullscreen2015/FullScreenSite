<?php
  ...
  $campo_principal[112]="tabela_ec_clientes_detalhes, tabela_ec_pedidos_detalhes";
  $campo_principal[113]="n_clientes";
  
  
  //Condi��o para Filtragem
  
   $campo_filtro[111]="tabela_ec_pedidos_detalhes.codigo_cliente=tabela_ec_clientes_detalhes.codigo_cliente AND tabela_ec_pedidos_detalhes.ativo=1 AND tabela_ec_clientes_detalhes.ativo=1 AND tabela_ec_clientes_detalhes.publicar=1 AND tabela_ec_pedidos_detalhes.codigo_situacao=5";  
  ...
  $sql2 = " SELECT count(DISTINCT(tabela_ec_clientes_detalhes." . $campo_principal[111] . ")) as " . $campo_principal[113];
 ...
 /* $sql3 = " SELECT DISTINCT(tabela_ec_clientes_detalhes." . $campo_principal[111] . ")";
  ...
  $sql3.= " ORDER BY tabela_ec_clientes_detalhes." . $campo_principal[111];
  ...
  */
  ...
  $nome_relatorio = "Melhores Clientes";
  
  // Campos do Grupo e Itens

   $sql = " SELECT tabela_ec_clientes_detalhes.*, COUNT(tabela_ec_pedidos_detalhes.codigo_pedido) as 'quantidade_de_pedidos' FROM tabela_ec_clientes_detalhes, tabela_ec_pedidos_detalhes";
  $sql.= " WHERE tabela_ec_pedidos_detalhes.codigo_cliente=tabela_ec_clientes_detalhes.codigo_cliente AND tabela_ec_pedidos_detalhes.ativo=1 AND tabela_ec_clientes_detalhes.ativo=1 AND tabela_ec_clientes_detalhes.publicar=1";
  $sql.= " AND tabela_ec_pedidos_detalhes.codigo_situacao=5";
  $sql.= " GROUP BY tabela_ec_clientes_detalhes.codigo_cliente";
  $sql.= " ORDER BY quantidade_de_pedidos DESC";
  ...
  $campos[141] = "ddd_tel_cliente,telefones_cliente";
  $campos[142] = "Telefone";
  ...
  $campos[151] = "ddd_cel_cliente,celular_cliente";
  $campos[152] = "Celular";
  $campos[153] = "varchar, varchar";
  $campos[154] = "tabela_ec_clientes_detalhes";
  $campos[155] = "15%";
  $campos[156] = " - ";
  
  $campos[161] = "quantidade_de_pedidos";
  $campos[162] = "Quantidade de Pedidos";
  $campos[163] = "inteiro";
