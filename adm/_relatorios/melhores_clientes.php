<?php
 ...
 /* $sql3 = " SELECT tabela_ec_clientes_detalhes." . $campo_principal[111];
 ...
 */
  ...
  // Campos do Grupo e Itens
   ...
   $sql = " SELECT tabela_ec_clientes_detalhes.*, SUM(tabela_ec_pedidos_detalhes.valor_pedido) as 'compras' FROM tabela_ec_clientes_detalhes, tabela_ec_pedidos_detalhes";
