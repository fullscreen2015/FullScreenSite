<?php
  ...
  $nome_relatorio = "Venda por Categoria";


  // Campos do Grupo


  $sql = " SELECT tabela_ec_produtos_categorias.*, SUM(tabela_ec_pedidos_itens.valor_unitario * tabela_ec_pedidos_itens.quantidade) as 'categoria_venda' ";
  $sql .= " FROM tabela_ec_produtos_detalhes, tabela_ec_produtos_categorias, tabela_ec_pedidos_itens, tabela_ec_pedidos_detalhes";
  ...
  $sql.= " ORDER BY categoria_venda DESC";
  ...
  $campos[131] = "categoria_venda";
  $campos[132] = "Venda Total";
  $campos[133] = "moeda";
  $campos[134] = "tabela_ec_produtos_categoria";
  $campos[135] = "15%";
  $campos[136] = "<br />";
