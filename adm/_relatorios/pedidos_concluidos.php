<?php
  ...
  $campo_principal[113]="n_encomenda";
  ...
  $nome_relatorio = "Encomendas Realizadas";
  
  // Campos do Grupo e Itens

  $sql = " SELECT p.codigo_pedido, p.valor_frete, p.numero_pedido, p.valor_pedido, p.codigo_cliente, p.data_pedido,p.valor_total, ";
  ...
  $campos[181] = "valor_unitario";
  $campos[182] = "Pre�o Unit�rio";
  $campos[183] = "moeda";
