<?php
  ...
  $nome_relatorio = "Margem de Lucro 1";
  ...
  $sql = " SELECT p.codigo_produto, SUM(p.preco_varejo) as total_varejo";
  $sql.= " , SUM(p.preco_atacado) as total_atacado";
  $sql.= " , SUM(p.preco_custo) as total_custo";
