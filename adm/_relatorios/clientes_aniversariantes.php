<?php
  ...
  $campo_principal[112]="tabela_ec_clientes_detalhes c, tabela_ec_clientes_enderecos en";
  $campo_principal[113]="n_clientes";
  
  
  //Condi��o para Filtragem
  
   $campo_filtro[111]="en.codigo_cliente = c.codigo_cliente AND substring(data_nascimento_cliente,5,2) LIKE '" . $mes_atual . "' AND publicar=1 AND c.ativo=1";  
  ...
  $sql2 = " SELECT count(DISTINCT(c." . $campo_principal[111] . ")) as " . $campo_principal[113];
  ...
  $sql3 = " SELECT DISTINCT(c." . $campo_principal[111].")";
  ...
  $sql3.= " ORDER BY c." . $campo_principal[111];
  ...
  $nome_relatorio = "Aniversariantes do M�s";
  
  // Campos do Grupo e Itens


  $sql = " SELECT DISTINCT(c.codigo_cliente), nome_cliente, cpf_cliente, cnpj_cliente, email_cliente, ddd_tel_cliente, telefones_cliente, ddd_cel_cliente, celular_cliente, data_nascimento_cliente,";
  $sql.= " cep_cliente, estado_cliente, cidade_cliente, bairro_cliente, cidade_cliente, bairro_cliente, complemento_cliente, endereco_cliente,numero_cliente"; 
  $sql.= " FROM tabela_ec_clientes_detalhes c, tabela_ec_clientes_enderecos en";
  $sql.= " WHERE en.codigo_cliente = c.codigo_cliente";
  $sql.= " AND substring(data_nascimento_cliente,5,2) LIKE '" . $mes_atual . "'";
  $sql.= " AND publicar=1";
  $sql.= " AND c.ativo=1";
  $sql.= " AND c.codigo_cliente BETWEEN " . $primeiro . " AND " . $ultimo;

  $sql.= " ORDER BY SUBSTRING(data_nascimento_cliente, 7, 2)  ASC";
  ...
  $campos[171] = "data_nascimento_cliente";
  $campos[172] = "Data de Nascimento";
  $campos[173] = "data_int";
  $campos[174] = "tabela_ec_clientes_detalhes";
  $campos[175] = "10%";
  $campos[176] = " | ";

  $campos[181] = "cep_cliente";
  $campos[182] = "CEP";
  $campos[183] = "inteiro";
  ...
  $campos[201] = "cidade_cliente,bairro_cliente";
  $campos[202] = "Cidade | Bairro";
  $campos[203] = "varchar,varchar";
  $campos[204] = "tabela_ec_clientes_enderecos";
  $campos[205] = "10%";
  $campos[206] = " - ";

  $campos[211] = "endereco_cliente,numero_cliente";
  $campos[212] = "Endere�o | N�mero";
  $campos[213] = "varchar,inteiro";
  $campos[214] = "tabela_ec_clientes_enderecos";
  $campos[215] = "20%";
  $campos[216] = ", ";

  $campos[221] = "complemento_cliente";
  $campos[222] = "Complemento";
  $campos[223] = "varchar";
  $campos[224] = "tabela_ec_clientes_enderecos";
  $campos[225] = "10%";
  $campos[226] = " <br /> ";
