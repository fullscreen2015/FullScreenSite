<?php
  ...
  $nome_relatorio = "Pedidos por Funcion�rio";


  // Campos do Grupo e Itens

  $sql = " SELECT tabela_adm_usuarios.codigo_usuario, nome_usuario, COUNT(codigo_pedido) as quantidade";
  $sql.= " FROM tabela_adm_usuarios, tabela_ec_pedidos_detalhes";
  ...
  $sql.= " ORDER BY COUNT(codigo_pedido) DESC";
  ...
  $campos[122] = "Quantidade de Pedidos";
  $campos[123] = "inteiro";
