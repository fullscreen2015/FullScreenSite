<?php
  ...
  $sql = " SELECT tabela_ec_produtos_detalhes.codigo_produto, referencia_produto, descricao_produto, texto_produto,  acessos, descricao_categoria,";
...
//echo $sql;
  ...
  {	
    ...
    {	 
      ...
      if($k>1)
      {
        if($numero_campos_item>0)
        {
          ...
          // ##########################################################################
          echo "<br /><font class=relatorio>Total de Itens no Estoque: ".$total_itens."</font><br /><br />";
          $total_itens=0;
          // ##########################################################################
	...
	if($a==0)
	{
	  echo '<table cellspacing="1" cellpadding="5" width="970px">';
	  $a++;		
	}
    ...
    else
    {
     ...
     // ##########################################################################
     //echo "<font class=relatorio>Total de itens: ".$total_itens."</font>";
     //$total_itens=0;
     // ##########################################################################
