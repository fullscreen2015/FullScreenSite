<?php
  ...
  //Condi��o para Filtragem
   ...
   $campo_filtro[111]="codigo_situacao=2 AND codigo_forma_de_pagamento=4 AND ativo=1 AND data_pedido < (now() - INTERVAL 1 DAY)"; 
  ...
  $nome_relatorio = "Vendas por boleto em aberto h� mais de um dia";
  ...
  $sql.= " AND pd.data_pedido < (now() - INTERVAL 1 DAY)";
