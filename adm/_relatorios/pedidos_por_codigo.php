<?php
 ...
 if(verifica_usuario_relatorio($arquivo))
 {
  ...
  $nome_relatorio = "Pedidos por C�digo";
  $codigo_pedido = $_REQUEST['codigo_pedido'];

  // Campos do Grupo


  $sql = " SELECT DISTINCT(p.codigo_pedido), descricao_tipo_envio, p.numero_pedido, p.valor_pedido, p.codigo_cliente, p.codigo_situacao, p.session, p.data_pedido, p.codigo_endereco, p.valor_frete, p.valor_total, p.codigo_forma_de_pagamento,";
  ...
  $sql.= " AND p.codigo_pedido = " . $codigo_pedido;
  ...
  $campos[171] = "codigo_forma_de_pagamento";
  $campos[172] = "C�digo da Forma de Pagamento (se houver)";
  $campos[173] = "inteiro";
  $campos[174] = "tabela_ec_pedido_detalhes";
  $campos[175] = "8%";
  $campos[176] = " - ";
  ...
  $sql_item.= " ,preco_varejo, preco_varejo_desconto, preco_atacado, preco_atacado_desconto";
  $sql_item.= " FROM tabela_ec_pedidos_itens pi" ;
  $sql_item.= " , tabela_ec_produtos_detalhes " ;
  $sql_item.= " WHERE pi.codigo_pedido = CAMPO-SQL-PRINCIPAL";
  $sql_item.= " AND pi.codigo_produto=tabela_ec_produtos_detalhes.codigo_produto";
  ...
  $campos_item[141] = "preco_varejo";
  $campos_item[142] = "Varejo";
  $campos_item[143] = "moeda";
  $campos_item[144] = "tabela_ec_produtos_detalhes";
  $campos_item[145] = "15%";
  $campos_item[146] = " - ";

  $campos_item[151] = "preco_varejo_desconto";
  $campos_item[152] = "Varejo c/Desconto";
  $campos_item[153] = "moeda";
  $campos_item[154] = "tabela_ec_produtos_detalhes";
  $campos_item[155] = "15%";
  $campos_item[156] = " - ";

  $campos_item[161] = "preco_atacado";
  $campos_item[162] = "Atacado";
  $campos_item[163] = "moeda";
  $campos_item[164] = "tabela_ec_produtos_detalhes";
  $campos_item[165] = "15%";
  $campos_item[166] = " - ";

  $campos_item[171] = "preco_atacado_desconto";
  $campos_item[172] = "Atacado c/Desconto";
  $campos_item[173] = "moeda";
  $campos_item[174] = "tabela_ec_produtos_detalhes";
  $campos_item[175] = "15%";
  $campos_item[176] = " - ";
