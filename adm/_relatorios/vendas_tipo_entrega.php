<?php
  ...
  $nome_relatorio = "Venda por Tipo de Entrega";


  // Campos do Grupo


  $sql = " SELECT tabela_ec_tipos_envio.*, SUM(tabela_ec_pedidos_itens.valor_unitario * tabela_ec_pedidos_itens.quantidade) as 'tipo_envio_venda' ";
  $sql .= " FROM tabela_ec_produtos_detalhes, tabela_ec_tipos_envio, tabela_ec_pedidos_itens, tabela_ec_pedidos_detalhes";
  ...
  $sql.= " AND tabela_ec_pedidos_detalhes.codigo_tipo_envio=tabela_ec_tipos_envio.codigo_tipo_envio ";
  $sql.= " AND tabela_ec_pedidos_detalhes.codigo_situacao=5";
  $sql.= " AND tabela_ec_pedidos_detalhes.ativo=1";
  $sql.= " GROUP BY tabela_ec_tipos_envio.codigo_tipo_envio";
  $sql.= " ORDER BY tipo_envio_venda DESC";

	

  $campos[111] = "codigo_tipo_envio";
  $campos[112] = "C�digo";
  $campos[113] = "chave_primaria";
  $campos[114] = "tabela_ec_tipos_envio";
  $campos[115] = "4%";
  $campos[116] = " - ";

  $campos[121] = "descricao_tipo_envio";
  $campos[122] = "Forma de Pagamento";
  $campos[123] = "varchar";
  $campos[124] = "tabela_ec_tipos_envio";
  $campos[125] = "25%";
  $campos[126] = " - ";

  $campos[131] = "tipo_envio_venda";
  $campos[132] = "Venda Total";
  $campos[133] = "moeda";
  $campos[134] = "tabela_ec_tipos_envio";
  $campos[135] = "15%";
  $campos[136] = "<br />";
