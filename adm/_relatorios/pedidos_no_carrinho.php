<?php
  ...
  //112-Tabelas em que se encontra o campo
  //113-Apelido do campo
  $campo_principal[111]="codigo_pedido";
  $campo_principal[112]="tabela_ec_pedidos_detalhes, tabela_ec_pedidos_itens";
  $campo_principal[113]="n_pedidos";
  
  
  //Condi��o para Filtragem
  
   $campo_filtro[111]="codigo_situacao=1 AND tabela_ec_pedidos_detalhes.ativo=1 AND tabela_ec_pedidos_itens.codigo_pedido = tabela_ec_pedidos_detalhes.codigo_pedido"; 
  ...
  $nome_relatorio = "Pedidos no Carrinho";

  // Campos do Grupo e Itens

  $sql = " SELECT p.codigo_pedido, p.numero_pedido, p.valor_pedido, p.data_pedido, p.codigo_cliente, ";
  $sql.= " pi.codigo_item, pi.descricao_item, pi.quantidade, pi.valor_unitario ";
  $sql.= " FROM tabela_ec_pedidos_detalhes p, tabela_ec_pedidos_itens pi";
  $sql.= " WHERE pi.codigo_pedido = p.codigo_pedido "; 
  $sql.= " AND p.codigo_pedido BETWEEN " . $primeiro . " AND " . $ultimo;
  
  $sql.= " AND p.codigo_situacao = 1 ";
  $sql.= " AND p.ativo = 1 ";
  ...
  $campos[131] = "codigo_cliente";
  $campos[132] = "C�d Cliente";
  $campos[133] = "chave_estrangeira";
  $campos[134] = "tabela_ec_pedidos_detalhes";
  $campos[135] = "6%";
  $campos[136] = "<br />";

  $campos[141] = "valor_pedido";
  $campos[142] = "Total Pedido";
  $campos[143] = "moeda";
  $campos[144] = "tabela_ec_pedidos_detalhes";
  $campos[145] = "10%";
  $campos[146] = " - ";
  
  $campos[151] = "quantidade";
  $campos[152] = "Quant";
  $campos[153] = "inteiro";
  $campos[154] = "tabela_ec_pedidos_itens";
  $campos[155] = "10%";
  $campos[156] = " - ";

  $campos[161] = "descricao_item";
  $campos[162] = "Produto";
  $campos[163] = "varchar";
  ...
  $campos[171] = "valor_unitario";
  $campos[172] = "Pre�o Unit�rio";
  $campos[173] = "moeda";
