<?
  ...
  if ($quantidade!=0)
  {
    ...
    $var_numero_paginas = (mysql_num_rows($rs_dados)-((mysql_num_rows($rs_dados)-$numero_linhas) % $registros_por_pagina)) / $registros_por_pagina +1;
    $var_numero_paginas = (int) $var_numero_paginas;



echo mysql_num_rows($rs_dados);
    ...
    mysql_data_seek ($rs_dados, ($pagina-1)*$numero_linhas);
