<?php
  ...
  $nome_relatorio = "Estoque abaixo da Quantidade M�nima";


  // Campos do Grupo e Itens

  $sql = " SELECT tabela_ec_produtos_detalhes.codigo_produto, referencia_produto, descricao_produto, texto_produto,  acessos, descricao_categoria, peso_produto,";
  ...
  $sql.= " AND tabela_ec_produtos_estoque.quantidade <= tabela_ec_produtos_estoque.quantidade_minima"; 
