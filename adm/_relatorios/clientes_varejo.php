<?php
  ...
  //Condi��o para Filtragem
   ...
   $campo_filtro[111]="revendedor_aprovado=0 AND revendedor_pedido=0 AND publicar=1 AND tabela_ec_clientes_detalhes.ativo=1 AND tabela_ec_clientes_detalhes.codigo_cliente = tabela_ec_clientes_enderecos.codigo_cliente";  
