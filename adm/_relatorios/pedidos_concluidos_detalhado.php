<?php
  ...
  $campo_principal[112]="tabela_ec_pedidos_detalhes p, tabela_ec_clientes_detalhes c, tabela_ec_clientes_enderecos en, tabela_ec_tipos_envio, tabela_ec_pedidos_itens pi";
  $campo_principal[113]="n_pedidos";
  
  
  //Condi��o para Filtragem
  
   $campo_filtro[111]="p.codigo_cliente = c.codigo_cliente AND p.codigo_tipo_envio = tabela_ec_tipos_envio.codigo_tipo_envio AND p.codigo_endereco = en.codigo_endereco AND p.codigo_cliente = en.codigo_cliente AND p.codigo_pedido = pi.codigo_pedido AND p.codigo_situacao = 5  AND p.ativo = 1 "; 
  ...
  $sql2 = " SELECT count(DISTINCT(p." . $campo_principal[111] . ")) as " . $campo_principal[113];
  ...
  $sql3 = " SELECT DISTINCT(p." . $campo_principal[111].")";
  ...
  $sql3.= " ORDER BY p." . $campo_principal[111];
  ...
  $nome_relatorio = "Pedidos Conclu�dos (recebidos pelo cliente)";
  
  // Campos do Grupo e Itens

  $sql = " SELECT p.codigo_pedido, p.numero_pedido, p.valor_pedido, p.data_pedido, p.valor_frete, p.valor_total, ";
  $sql.= " pi.descricao_item,pi.quantidade,pi.valor_unitario,";
  $sql.= " c.nome_cliente, c.email_cliente, c.cpf_cliente, c.cnpj_cliente, descricao_tipo_envio,";
  ...
  $sql.= " FROM tabela_ec_pedidos_detalhes p,  tabela_ec_clientes_detalhes c, tabela_ec_clientes_enderecos en, tabela_ec_tipos_envio, tabela_ec_pedidos_itens pi";
