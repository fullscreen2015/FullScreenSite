<?php
  ...
  $sql = " SELECT DISTINCT(p.codigo_pedido), p.numero_pedido, p.valor_pedido, p.codigo_cliente, p.session, p.data_pedido";
  $sql.= " FROM tabela_ec_pedidos_detalhes p, tabela_ec_pedidos_itens i";
  $sql.= " WHERE p.codigo_situacao = 1 ";
  $sql.= " AND p.ativo = 1 ";
  ...
  $campos[132] = "C�digo do Cliente (se houver)";
  $campos[133] = "inteiro";
