<?php
  ...
  $nome_relatorio = "Venda por Boleto em Aberto";
  ...
  $sql.= " AND (tabela_ec_pedidos_detalhes.codigo_situacao=2 AND tabela_ec_pedidos_detalhes.codigo_forma_de_pagamento=4)";
