<?php
  ...
  $sql = " SELECT SUM(tabela_ec_pedidos_itens.valor_unitario * tabela_ec_pedidos_itens.quantidade) as 'produto_venda', descricao_produto, tabela_ec_produtos_detalhes.codigo_produto, referencia_produto ";
  $sql .= " FROM tabela_ec_produtos_detalhes, tabela_ec_pedidos_itens, tabela_ec_pedidos_detalhes";
  ...
  $sql.= " ORDER BY produto_venda DESC";
  ...
  $campos[141] = "produto_venda";
  $campos[142] = "Venda Total";
  $campos[143] = "moeda";
