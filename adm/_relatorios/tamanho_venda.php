<?php
  ...
  $nome_relatorio = "Venda por Tamanho";
  ...
  $sql.= " GROUP BY descricao_tamanho";
  $sql.= " ORDER BY tamanho_venda DESC";

	

  $campos[111] = "codigo_tamanho";
  $campos[112] = "C�digo";
  ...
  $campos[121] = "descricao_tamanho";
  $campos[122] = "Tamanho";
  $campos[123] = "varchar";
  $campos[124] = "tabela_ec_produtos_tamanhos";
  $campos[125] = "25%";
  $campos[126] = " - ";

  $campos[131] = "tamanho_venda";
  $campos[132] = "Venda Total";
  $campos[133] = "moeda";
  $campos[134] = "tabela_ec_produtos_tamanhos";
  $campos[135] = "15%";
  $campos[136] = "<br />";
