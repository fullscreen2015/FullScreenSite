<?php
  ...
  $nome_relatorio = "Venda por Forma de pagamento";


  // Campos do Grupo


  $sql = " SELECT tabela_ec_formas_de_pagamento.*, SUM(tabela_ec_pedidos_itens.valor_unitario * tabela_ec_pedidos_itens.quantidade) as 'forma_de_pagamento_venda' ";
  $sql .= " FROM tabela_ec_produtos_detalhes, tabela_ec_formas_de_pagamento, tabela_ec_pedidos_itens, tabela_ec_pedidos_detalhes";
  ...
  $sql.= " AND tabela_ec_pedidos_detalhes.codigo_forma_de_pagamento=tabela_ec_formas_de_pagamento.codigo_forma_de_pagamento ";
  $sql.= " AND tabela_ec_pedidos_detalhes.codigo_situacao=5";
  $sql.= " AND tabela_ec_pedidos_detalhes.ativo=1";
  $sql.= " GROUP BY tabela_ec_formas_de_pagamento.codigo_forma_de_pagamento";
  $sql.= " ORDER BY forma_de_pagamento_venda DESC";

	

  $campos[111] = "codigo_forma_de_pagamento";
  $campos[112] = "C�digo";
  $campos[113] = "chave_primaria";
  $campos[114] = "tabela_ec_formas_de_pagamento";
  $campos[115] = "4%";
  $campos[116] = " - ";

  $campos[121] = "descricao_forma_de_pagamento";
  $campos[122] = "Forma de Pagamento";
  $campos[123] = "varchar";
  $campos[124] = "tabela_ec_formas_de_pagamento";
  $campos[125] = "25%";
  $campos[126] = " - ";

  $campos[131] = "forma_de_pagamento_venda";
  $campos[132] = "Venda Total";
  $campos[133] = "moeda";
  $campos[134] = "tabela_ec_produtos_forma_de_pagamento";
  $campos[135] = "15%";
  $campos[136] = "<br />";
