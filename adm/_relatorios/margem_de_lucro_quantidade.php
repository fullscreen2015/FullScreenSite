<?php
  ...
  $nome_relatorio = "Margem de Lucro 2";


  // Campos do Grupo


 $sql = " SELECT p.codigo_produto, SUM(tabela_ec_produtos_estoque.quantidade) as quantidade_por_produto";
  ...
  $campos[111] = "total_varejo";
  $campos[112] = "Margem de Lucro no Varejo";
  $campos[113] = "lucro";
  $campos[114] = "tabela_ec_produtos_detalhes";
  $campos[115] = "15%";
  $campos[116] = "<br />";

  $campos[121] = "total_atacado";
  $campos[122] = "Margem de Lucro no Atacado";
  $campos[123] = "lucro";
    ...
    for($cont=1;$cont<=$numero_campos;$cont++)
    {
      ...
      foreach($campos_para_mostrar AS $nome_do_campo_para_mostrar)
      {
        ...
        switch ($tipos_para_mostrar[$i])
        {
          ...
          case "moeda":
            $valores_para_mostrar = "R$ " . number_format($valores_para_mostrar,2,',','.');
            break;

          case "lucro":
			
			$margem = $linha["$nome_do_campo_para_mostrar"]-$linha['total_custo'];
			$margem = $valores_para_mostrar*100/$linha["$nome_do_campo_para_mostrar"];
