<?php
  ...
  $sql.= " WHERE codigo_cliente=" . $codigo_cliente;
  ...
  $sql_item = " SELECT * FROM tabela_ec_log, tabela_ec_clientes_detalhes";
  $sql_item.= " WHERE tabela_ec_log.codigo_cliente = tabela_ec_clientes_detalhes.codigo_cliente " ;
  $sql_item.= " AND tabela_ec_log.codigo_cliente = CAMPO-SQL-PRINCIPAL";
  $sql_item.= " ORDER BY codigo_log,data,hora";
  $campo_sql_principal="codigo_cliente";


  $campos_item[111] = "session";
  $campos_item[112] = "SESSION";
  $campos_item[113] = "varchar";
  $campos_item[114] = "tabela_ec_log";
  $campos_item[115] = "45%";
  $campos_item[116] = " - ";

  $campos_item[121] = "acao";
  $campos_item[122] = "A��o";
  $campos_item[123] = "varchar";
  $campos_item[124] = "tabela_ec_log";
  $campos_item[125] = "45%";
  $campos_item[126] = "<br />";

  $campos_item[131] = "data";
  $campos_item[132] = "Data";
  $campos_item[133] = "data_int";
  $campos_item[134] = "tabela_ec_log";
  $campos_item[135] = "5%";
  $campos_item[136] = " - ";

  $campos_item[141] = "hora";
  $campos_item[142] = "Hora";
  $campos_item[143] = "hora_int";
  $campos_item[144] = "tabela_ec_log";
  $campos_item[145] = "5%";
  $campos_item[146] = ", ";
