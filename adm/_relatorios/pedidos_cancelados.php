<?php
  ...
  $nome_relatorio = "Pedidos Cancelados";


  // Campos do Grupo e Itens

  $sql = " SELECT p.codigo_pedido, p.numero_pedido, p.valor_pedido, p.codigo_cliente, p.data_pedido, ";
  ...
  $sql.= " FROM tabela_ec_pedidos_detalhes p, tabela_ec_pedidos_itens pi, tabela_ec_clientes_detalhes c";
