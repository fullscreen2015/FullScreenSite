<?php
  ...
  $sql.= " , ((SUM(tabela_ec_produtos_estoque.quantidade))*p.preco_varejo) as total_varejo";
  $sql.= " , ((SUM(tabela_ec_produtos_estoque.quantidade))*p.preco_atacado) as total_atacado";
  $sql.= " , ((SUM(tabela_ec_produtos_estoque.quantidade))*p.preco_custo) as total_custo";
  ...
  $sql.= " p.ativo = 1 AND";
  $sql.= " p.publicar = 1 AND";
  $sql.= " c.publicar = 1";
  $sql.= " AND p.preco_custo > 0";
 // $sql.= " AND tabela_ec_produtos_estoque.quantidade > 0";  
  $sql.= " GROUP BY p.codigo_produto";
  $sql.= " ORDER BY quantidade_por_produto DESC";
  ...
  $campos[131] = "quantidade_por_produto";
  $campos[132] = "Estoque";
  $campos[133] = "varchar";
  $campos[134] = "tabela_ec_produtos_estoque";
  $campos[135] = "10%";
  $campos[136] = "<br />";

  $campos[141] = "total_varejo";
  $campos[142] = "Total no Varejo";
  $campos[143] = "moeda";
  $campos[144] = "tabela_ec_produtos_detalhes";
  $campos[145] = "15%";
  $campos[146] = "<br />";

  $campos[151] = "total_atacado";
  $campos[152] = "Total no Atacado";
  $campos[153] = "moeda";
  $campos[154] = "tabela_ec_produtos_detalhes";
  $campos[155] = "15%";
  $campos[156] = "<br />";

  $campos[161] = "total_custo";
  $campos[162] = "Total no Custo";
  $campos[163] = "moeda";
  $campos[164] = "tabela_ec_produtos_detalhes";
  $campos[165] = "15%";
  $campos[166] = "<br />";
  
  $campos[171] = "total_varejo,total_atacado";
  $campos[172] = "Margem de Lucro(Varejo/Atacado)";
  $campos[173] = "lucro,lucro";
  $campos[174] = "tabela_ec_produtos_detalhes";
  $campos[175] = "10%";
  $campos[176] = " / ";
  ...
  while ($linha = mysql_fetch_array($rs_dados))
  {
    ...
    // PERSONALIZA��O INICIO
    $total_estoque+=$linha["quantidade_por_produto"];
    $total_varejo+=$linha["total_varejo"];
    $total_atacado+=$linha["total_atacado"];
    ...
    for($cont=1;$cont<=$numero_campos;$cont++)
    {
      ...
      foreach($campos_para_mostrar AS $nome_do_campo_para_mostrar)
      {
        ...
        case "lucro":
			if($linha["$nome_do_campo_para_mostrar"]>0)
			{
			  $margem = $linha["$nome_do_campo_para_mostrar"]-$linha['total_custo'];
			  $margem = $margem*100/$linha["$nome_do_campo_para_mostrar"];
              $valores_para_mostrar.= number_format($margem,2,',','.') . "%";
			}
			else
			{
              $valores_para_mostrar.= "0%";			  
			}
			break;
    ...
    echo "<br /><br /><b>Total em Estoque:</b> " . number_format($total_estoque,0,',','.') . " pe�as";
    echo "<br /><br /><b>Total no Varejo:</b> R$ " . number_format($total_varejo,2,',','.');
    echo "<br /><br /><b>Total no Atacado:</b> R$ " . number_format($total_atacado,2,',','.');
    echo "<br /><br /><b>Total Custo:</b> R$ " . number_format($total_custo,2,',','.');
    echo "</font>";
    // PERSONALIZA��O FIM
