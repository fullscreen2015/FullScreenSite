<?php
  ...
  $campo_principal[112]="tabela_ec_clientes_detalhes, tabela_ec_clientes_enderecos";
  $campo_principal[113]="n_clientes";
  
  
  //Condi��o para Filtragem
  
   $campo_filtro[111]="revendedor_aprovado=1 AND publicar=1 AND tabela_ec_clientes_detalhes.ativo=1 AND tabela_ec_clientes_detalhes.codigo_cliente = tabela_ec_clientes_enderecos.codigo_cliente";  
  ...
  $nome_relatorio = "Clientes - Revendedores";
