<?php
  ...
  $nome_relatorio = "Produtos - Margem de Lucro";
  ...
  $campos[131] = "total_varejo";
  $campos[132] = "Margem de Lucro no Varejo";
  $campos[133] = "lucro";
  $campos[134] = "tabela_ec_produtos_detalhes";
  $campos[135] = "25%";
  $campos[136] = "<br />";

  $campos[141] = "total_atacado";
  $campos[142] = "Margem de Lucro no Varejo";
  $campos[143] = "lucro";
      ...
      foreach($campos_para_mostrar AS $nome_do_campo_para_mostrar)
      {
        ...
        switch ($tipos_para_mostrar[$i])
        {
          ...
          case "lucro":
			...
			$valores_para_mostrar = $linha["$nome_do_campo_para_mostrar"] - $linha["total_custo"];
			$valores_para_mostrar = $valores_para_mostrar*100/$linha["$nome_do_campo_para_mostrar"];
            $valores_para_mostrar = number_format($valores_para_mostrar, 2, ".", "");
			$valores_para_mostrar.= "%";
			break;
