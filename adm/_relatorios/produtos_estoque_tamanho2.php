<?php
  ...
  $sql = " SELECT tabela_ec_produtos_detalhes.codigo_produto, referencia_produto, descricao_produto, texto_produto, descricao_categoria, SUM(tabela_ec_produtos_estoque.quantidade) as quantidade_por_produto,";
  $sql.= " SUM(tabela_ec_produtos_estoque.quantidade) as quantidade_por_tamanho, descricao_tamanho";
  $sql.= " FROM tabela_ec_produtos_detalhes, tabela_ec_produtos_categorias, tabela_ec_produtos_estoque, tabela_ec_produtos_tamanhos";
  ...
  $sql.= " GROUP BY tabela_ec_produtos_estoque.codigo_estoque, tabela_ec_produtos_tamanhos.codigo_tamanho";
  ...
  $campos[161] = "quantidade_por_tamanho";
  $campos[162] = "Quantidade em Estoque";
  $campos[163] = "inteiro";
  $campos[164] = "tabela_ec_produtos_estoque";
  $campos[165] = "70%";
  $campos[166] = " - ";
  
  $campos[171] = "descricao_tamanho";
  $campos[172] = "Tamanho";
  $campos[173] = "varchar";
  $campos[174] = "tabela_ec_produtos_tamanhos";
  $campos[175] = "30%";
  $campos[176] = "<br>";
