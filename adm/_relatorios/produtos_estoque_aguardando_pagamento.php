<?php
  ...
  $nome_relatorio = "Estoque Aguardando Pagamento";
  ...
  $sql.= " FROM tabela_ec_produtos_detalhes, tabela_ec_produtos_categorias, tabela_ec_produtos_estoque, tabela_ec_produtos_cores, tabela_ec_produtos_tamanhos, tabela_ec_pedidos_itens, tabela_ec_pedidos_detalhes";
  ...
  $sql.= " AND tabela_ec_produtos_estoque.codigo_estoque= tabela_ec_pedidos_itens.codigo_estoque"; 
