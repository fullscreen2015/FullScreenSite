<?
  ...
  function edit($descricao_campo,$nome_campo,$tam,$help)
  {  
    global $linha;  ?>
...
<? 
  ...
  function edit2($descricao_campo,$nome_campo,$tam,$tabela,$validacao,$help)
  {  
...
////////////////////////////////////////////////////////////////////////////////////////////
  ...
  // fun��o criada para adicionar campo não editavel
  function edit_nao_editavel($descricao_campo,$nome_campo,$tam,$tabela,$validacao,$help)
  {  
    ...
    echo '<input type="text" maxlength="' . $tam . '"   readonly="true" class="input" id="'. $nome_campo . '" alt="' . $valor_alt . '" value="' . $linha[$nome_campo] . '" name="'. $nome_campo . '">';
    echo '</div>';
...
/////////////acima campo não editavel///////////////////////////////////////////////////





  function edit_moeda($descricao_campo,$nome_campo,$tam,$validacao,$help)
  {  
    global $linha;  
...
<? 
  ...
  function edit_real($descricao_campo,$nome_campo,$tam,$help)
  {  
    global $linha;  ?>
...
<? 
  ...
  function edit_inteiro($descricao_campo,$nome_campo,$tam,$validacao,$help)
  {  
    global $linha;  
...
<? 
  ...
  function edit_senha($descricao_campo,$nome_campo,$tam,$help)
  {  
    global $linha;  ?>
...
<? 
  ...
  function edit_senha_md5($cont,$descricao_campo,$nome_campo,$tam)//$help
  {  
  ...
  function input($descricao_campo,$nome_campo,$tam,$help)
  {  ?>
...
<? 
  ...
  function input2($descricao_campo,$nome_campo,$tam,$tabela,$validacao,$help)
  {  
    global $sistema_exclusao;
...
function input_senha_md5($descricao_campo,$nome_campo,$tam)//$help
  {  ?>
...
<? 
  ...
  function input_moeda($descricao_campo,$nome_campo,$tam,$validacao,$help)
  {  
...
<? 
  ...
  function input_real($descricao_campo,$nome_campo,$tam,$help)
  {  ?>
...
<? 
  ...
  function input_inteiro($descricao_campo,$nome_campo,$tam,$validacao,$help)
  {
...
<? 
  ...
  function editor($descricao_campo,$nome_campo,$tam,$help)
  { 
    ...
    echo '<font class="preto_8"><b>' . $descricao_campo . ': &nbsp;</b></font>';
      if($help!="")
      {
      echo "<img src='../_imagens/info.png' width='16' alt='" . $help . "' title='" . $help . "'><br><br>";
      }
  ...
  function editor_edit($descricao_campo,$nome_campo,$tam,$help)
  {
    global $linha;  
    ...
    echo '<font class="preto_8"><b>' . $descricao_campo . ': &nbsp;</b></font>';
        if($help!="")
        {
         echo "<img src='../_imagens/info.png' width='16' alt='" . $help . "' title='" . $help . "'><br>";
        }
  ...
  function textarea($descricao_campo,$nome_campo,$tam,$help)
  {  ?>
...
<? 
  ...
  function textarea_edit($descricao_campo,$nome_campo,$tam,$help)
  {  
    global $linha;  
...
<? 
  ...
  function check($descricao_campo,$nome_campo,$help)
  {
    global $linha;   ?>
...
<? 
  ...
  function data($descricao_campo,$nome_campo,$help)
  {  
  ...
  function data2($descricao_campo,$nome_campo,$validacao,$help)
  {  
  ...
  function data_now($descricao_campo,$nome_campo,$help)
  {
...
<? 
  ...
  function data_now_fixo($descricao_campo,$nome_campo,$help)
  {
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <tr valign="middle"> 
        ...
        <td width="50%">
          ...
          <input disabled="disabled" size=2 class="select" alt="<? echo $descricao_campo; ?> - Dia" name="<? echo $nome_campo; ?>_dia" maxlength=2 value="<? echo $valor_dia; ?>">
          <input type="hidden" size=2 class="select" alt="<? echo $descricao_campo; ?> - Dia" name="<? echo $nome_campo; ?>_dia" maxlength=2 value="<? echo $valor_dia; ?>">
          /
          <input disabled="disabled" size=2 class="select" alt="<? echo $descricao_campo; ?> - M�s" name="<? echo $nome_campo; ?>_mes" value="<? echo $valor_mes; ?>">          
          <input type="hidden" size=2 class="select" alt="<? echo $descricao_campo; ?> - M�s" name="<? echo $nome_campo; ?>_mes" value="<? echo $valor_mes; ?>">          
          /
          <input disabled="disabled" size=4 class="select" alt="<? echo $descricao_campo; ?> - Ano" name="<? echo $nome_campo; ?>_ano" value="<? echo $valor_ano; ?>" >         
          <input type="hidden" size=4 class="select" alt="<? echo $descricao_campo; ?> - Ano" name="<? echo $nome_campo; ?>_ano" value="<? echo $valor_ano; ?>" >         
          </font></td>
      </tr>
    </table>
...
<? 
  ...
  function data_now_edit($descricao_campo,$nome_campo,$help)
  {
...
<? 
 ...
 function data_hora_inserir($descricao_campo,$nome_campo,$help)
  {
...
<? 
 ...
 function data_hora_editar($descricao_campo,$nome_campo,$help)
  {
...
<? 
  ...
  function hora($descricao_campo,$nome_campo,$help)
  {  ?>
...
<? 
  ...
  function hora_edit($descricao_campo,$nome_campo,$help)
  {  
...
<? 
  ...
  function hora_now($descricao_campo,$nome_campo,$help)
  {  ?>
...
<? 
  ...
  function hora_now_fixo($descricao_campo,$nome_campo,$help)
  {  
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <tr valign="middle"> 
        ...
        <td width="50%">
          <font class="preto_8">
            <input disabled="disabled" size=2 class="select" name="<? echo $nome_campo; ?>_hora" maxlength=2 value="<? echo date("H"); ?>">
            <input type="hidden" size=2 class="select" name="<? echo $nome_campo; ?>_hora" maxlength=2 value="<? echo date("H"); ?>">
            :
            <input disabled="disabled" size=2 class="select" name="<? echo $nome_campo; ?>_minuto" maxlength=2 value="<? echo date("i"); ?>">
            <input type="hidden" size=2 class="select" name="<? echo $nome_campo; ?>_minuto" maxlength=2 value="<? echo date("i"); ?>">
            :
            <input disabled="disabled" size=2 class="select" name="<? echo $nome_campo; ?>_segundo" maxlength=2 value="<? echo date("s"); ?>">
            <input type="hidden" size=2 class="select" name="<? echo $nome_campo; ?>_segundo" maxlength=2 value="<? echo date("s"); ?>">
          </font></td>
      </tr>
    </table>
...
<? 
 ...
 function hora_fixo_edit($descricao_campo,$nome_campo,$help)
  {  
    global $linha;
    date_default_timezone_set('Brazil/East');

    $segundos = (int)($linha[$nome_campo]%100);
    $minutos = (int)($linha[$nome_campo]/100);
    $minutos = (int)($minutos%100);
    $hora = (int)($linha[$nome_campo]/10000);
    ?>
    ...
    <table border="0" cellspacing="0" cellpadding="0" width="100%">
      <tr valign="middle"> 
        ...
        <td width="50%">
          <font class="preto_8">
            <input disabled="disabled" size=2 class="select" name="<? echo $nome_campo; ?>_hora" maxlength=2 value="<? echo $hora; ?>">
            <input type="hidden" size=2 class="select" name="<? echo $nome_campo; ?>_hora" maxlength=2 value="<? echo $hora; ?>">
            :
            <input disabled="disabled" size=2 class="select" name="<? echo $nome_campo; ?>_minuto" maxlength=2 value="<? echo $minutos; ?>">
            <input type="hidden" size=2 class="select" name="<? echo $nome_campo; ?>_minuto" maxlength=2 value="<? echo $minutos; ?>">
            :
            <input disabled="disabled" size=2 class="select" name="<? echo $nome_campo; ?>_segundo" maxlength=2 value="<? echo $segundos; ?>">
            <input type="hidden" size=2 class="select" name="<? echo $nome_campo; ?>_segundo" maxlength=2 value="<? echo $segundos; ?>">
          </font></td>
      </tr>
    </table>
...
<? 
  ...
  function data_date_edit($descricao_campo,$nome_campo,$help)
  {
...
<? 
  ...
  function data_int_edit($descricao_campo,$nome_campo,$help)
  {
  ...
  function data_int_edit2($descricao_campo,$nome_campo,$validacao,$help)
  {
