...
// Sistema de Fotos
  ...
  // * para utilizar o redimensionamento automático 2 (com seleção) é necessário informar largura e altura mínimos
  $largura_minima = 150;
  $altura_minima = 150;

  // * para utilizar o redimensionamento automático 2 (com seleção) é necessário utilizar a mesmo tipo de arquivo para os três tamanhos
...
// Identifica��o do campo que guardar� o codigo do usuário (se houver - se não houver, deixar em branco)
  ...
  $campo_usuario = "codigo_usuario";
  $tipo_permissao_usuario = "1";
...
// - nao_editavel   //campo não edit�vel somente leitura
  ...
  $campos[121] = "senha_usuario";
  $campos[122] = "Senha";
  $campos[123] = "senha_criptografada";
  $campos[124] = "255";
  $campos[125] = "obrigatorio";
  $campos[126] = "";
  $campos[127] = "";
  $campos[128] = 0;
  $campos[129] = 0;
