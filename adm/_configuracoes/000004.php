...
// Identifica��o da tabela
  ...
  $tabela = "tabela_adm_graficos";
  $chave_primaria = "codigo_grafico";
  $descricao_principal = "descricao_grafico";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_grafico";



// Identifica��o do Sistema

  $sistema_singular = "Gr�fico";
  $sistema_plural = "Gr�ficos";
...
// 17 - possibilidade de preenchimento (0 - insere e edita  / 1 - só insere e não edita / 2 - não insere e não edita)
