...
// Identifica��o da tabela
  ...
  $tabela = "tabela_adm_sistemas";
  $chave_primaria = "codigo_sistema";
  $descricao_principal = "descricao_sistema";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_sistema";



// Identifica��o do Sistema

  $sistema_singular = "M�dulo";
  $sistema_plural = "M�dulos";
...
// - nao_editavel   //campo não edit�vel somente leitura
  ...
  $campos[1212] = "";
  $campos[1213] = "";
  $campos[1214] = "Digite aqui o nome do m�dulo";
  $campos[1215] = "";

  $campos[131] = "texto_sistema";
  $campos[132] = "Texto";
  $campos[133] = "blob";
  $campos[134] = "5000";
  $campos[135] = "";
  ...
  $campos[1312] = "";
  $campos[1313] = "";
  $campos[1314] = "Digite, se desejar, uma breve descri��o deste m�dulo";
  $campos[1315] = "";

  $campos[141] = "tabela_sistema";
  $campos[142] = "Tabela";
  $campos[143] = "varchar";
  $campos[144] = "255";
  $campos[145] = "";
  ...
  $campos[1412] = "";
  $campos[1413] = "";
  $campos[1414] = "Digite aqui o nome da tabela principal utilizada por este m�dulo. Deixar em branco se não desejar que seja informado o n�mero de registros ao lado do nome do m�dulo.";
  $campos[1415] = "";

  $campos[151] = "campo_principal_sistema";
  $campos[152] = "Chave Prim�ria do M�dulo";
  $campos[153] = "varchar";
  $campos[154] = "255";
  $campos[155] = "";
  $campos[156] = "";
  ...
  $campos[1512] = "";
  $campos[1513] = "";
  $campos[1514] = "Digite aqui o nome do campo Chave Prim�ria deste m�dulo. Deixar em branco se não desejar que seja informado o n�mero de registros ao lado do nome do m�dulo.";
  $campos[1515] = "";

  $campos[161] = "sistema_exclusao";
  $campos[162] = "Tem sistema de exclusão?";
  $campos[163] = "logico";
  $campos[164] = "1";
  $campos[165] = "";
  $campos[166] = "";
  ...
  $campos[1612] = "";
  $campos[1613] = "";
  $campos[1614] = "Marque esta opção caso este m�dulo utilize sistema de exclusão (necessário campo ativo na tabela principal)";
  $campos[1615] = "";
  ...
  $campos[1712] = "";
  $campos[1713] = "";
  $campos[1714] = "Marque esta opção para disponibilizar este m�dulo no sistema";
  $campos[1715] = "";
...
// 91 - chave prim�ria da tabela associativa
  ...
  $campos_associativos[111] = "codigo_caracteristica";
  $campos_associativos[112] = "Caracter�stica";

  $campos_associativos[114] = "0";
  $campos_associativos[115] = "codigo_caracteristica";
  $campos_associativos[116] = "tabela_ec_produtos_caracteristicas";
  $campos_associativos[117] = "descricao_caracteristica";

  $campos_associativos[118] = "tabela_ec_produtos_ass_caracteristica_produto";
  $campos_associativos[119] = "codigo_produto";
