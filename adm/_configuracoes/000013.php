...
// Sistema de Fotos
  ...
  $largura_maxima = 3140;//CAMPO NOVO
  $altura_maxima = 5190;// CAMPO NOVO
  ...
  $largura_thumbs = 146;
  $altura_thumbs = 85;
  $largura_maxima_thumbs = 146;
  $altura_maxima_thumbs = 85;
  $largura_minima_thumbs = 146;
  $altura_minima_thumbs = 85;
  $tamanho_maximo_thumbs = 30000;

  $largura_foto = 314;
  $altura_foto = 519;
  $largura_maxima_foto = 314;
  $altura_maxima_foto = 519;
  $largura_minima_foto = 314;
  $altura_minima_foto = 519;
...
// Sistema de Documentos
  ...
  $tipos_arquivo_aceitos_extensao = array("mp3", "rar", "pdf");
...
// Identifica��o da tabela
  ...
  $tabela = "tabela_arquivos";
  $chave_primaria = "codigo_arquivo";
  $descricao_principal = "nome_arquivo";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_arquivo";



// Identifica��o do Sistema

  $sistema_singular = "Arquivo";
  $sistema_plural = "Arquivos";
...
// - senha_criptografada
  ...
  $campos[1212] = "";
  $campos[1213] = "";
  $campos[1214] = "Digite aqui o nome do arquivo";
  $campos[1215] = "";
  ...
  $campos[1312] = "";
  $campos[1313] = "";
  $campos[1314] = "Marque aqui se deseja que o arquivo fique dispon�vel para download";
  $campos[1315] = "";
...
// 91 - chave prim�ria da tabela associativa
  ...
  $campos_associativos[111] = "codigo_nivel";
  $campos_associativos[112] = "N�veis que tem acesso";
