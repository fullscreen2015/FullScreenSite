...
// Sistema de Fotos
  ...
  $nome_sistema_fotos = "imagens/cores";
  $numero_algarismos = 6;
...
// Identifica��o da tabela
  ...
  $tabela = "tabela_adm_usuarios";
  $chave_primaria = "codigo_usuario";
  $descricao_principal = "nome_usuario";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_usuario";



// Identifica��o do Sistema

  $sistema_singular = "Funcion�rio";
  $sistema_plural = "Funcion�rios";
...
// - nao_editavel   //campo não edit�vel somente leitura
  ...
  $campos[1212] = "";
  $campos[1213] = "";
  $campos[1214] = "Digite aqui o nome do usuário";
  $campos[1215] = "";

  $campos[131] = "email_usuario";
  $campos[132] = "E-mail (login)";
  $campos[133] = "varchar";
  $campos[134] = "255";
  $campos[135] = "email";
  $campos[136] = "";
  ...
  $campos[138] = 1;
  $campos[139] = 1;
  $campos[1310] = "obrigatorio";
  $campos[1311] = "300";
  $campos[1312] = "";
  $campos[1313] = "";
  $campos[1314] = "Digite aqui o email do usuário, que será utilizado como Login";
  $campos[1315] = "";
  
  $campos[141] = "senha_usuario";
  $campos[142] = "Senha";
  $campos[143] = "senha_criptografada";
  $campos[144] = "255";
  $campos[145] = "obrigatorio";
  $campos[146] = "";
  $campos[147] = "";
  $campos[148] = 0;
  $campos[149] = 0;
  ...
  $campos[151] = "administrador_sistema";
  $campos[152] = "Administrador do Sistema";
  $campos[153] = "logico";
  $campos[154] = "";
  $campos[155] = "";
  $campos[156] = "";
  ...
  $campos[1512] = "";
  $campos[1513] = "";
  $campos[1514] = "Marque esta opção caso este usuário seja Administrador do Sistema";
  $campos[1515] = "";
  ...
  $campos[1612] = "";
  $campos[1613] = "";
  $campos[1614] = "Marque esta opção para liberar o acesso deste usuário ao sistema";
  $campos[1615] = "";
...
// 91 - chave prim�ria da tabela associativa
  ...
  $sistema_relacionado[1] = "";
  $sistema_relacionado[2] = "";
