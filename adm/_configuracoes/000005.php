...
// Identifica��o da tabela
  ...
  $tabela = "tabela_adm_relatorios";
  $chave_primaria = "codigo_relatorio";
  $descricao_principal = "descricao_relatorio";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_relatorio";



// Identifica��o do Sistema

  $sistema_singular = "Relat�rio";
  $sistema_plural = "Relat�rios";
...
// - nao_editavel   //campo não edit�vel somente leitura
  ...
  $campos[121] = "descricao_relatorio";
  $campos[122] = "T�tulo";
  $campos[123] = "varchar";
  $campos[124] = "255";
  $campos[125] = "";
...
// 91 - chave prim�ria da tabela associativa
  ...
  $campos_associativos[118] = "tabela_adm_ass_usuario_relatorio";
  $campos_associativos[119] = "codigo_relatorio";
