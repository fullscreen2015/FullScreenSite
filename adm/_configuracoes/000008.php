...
// Identifica��o da tabela
  ...
  $tabela = "tabela_categorias_portifolios";
  $chave_primaria = "codigo_categoria";
  $descricao_principal = "descricao_categoria";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_categoria";



// Identifica��o do Sistema

  $sistema_singular = "Categoria Portif�lio";
  $sistema_plural = "Categorias Portif�lios";
