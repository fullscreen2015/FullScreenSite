...
// Sistema de Fotos
  ...
  $nome_sistema_fotos = "imagens/portifolio";
  $numero_algarismos = 6;
...
// Identifica��o da tabela
  ...
  $tabela = "tabela_portifolios";
  $chave_primaria = "codigo_portifolio";
  $descricao_principal = "nome_portifolio";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_portifolio";



// Identifica��o do Sistema

  $sistema_singular = "Portif�lio";
  $sistema_plural = "Portif�lios";
...
// - senha_criptografada
  ...
  $campos[131] = "codigo_categoria";
  $campos[132] = "Categoria do cliente";
  $campos[133] = "chave_estrangeira";
  $campos[134] = "0";
  $campos[135] = "codigo_categoria";
  $campos[136] = "tabela_categorias_portifolios";
  $campos[137] = "descricao_categoria";
  $campos[138] = 1;
  $campos[139] = 1;
  ...
  $campos[141] = "url_portifolio";
  $campos[142] = "URL (ex.: http://www.google.com.br)";
  $campos[143] = "varchar";
  $campos[144] = "255";
  $campos[145] = "";
  $campos[146] = "";
