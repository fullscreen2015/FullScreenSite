...
// Identifica��o da tabela
  ...
  $tabela = "tabela_avisos_clientes";
  $chave_primaria = "codigo_aviso";
  $descricao_principal = "texto_aviso";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_aviso";



// Identifica��o do Sistema

  $sistema_singular = "Aviso";
  $sistema_plural = "Avisos";
