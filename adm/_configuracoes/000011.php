...
// Identifica��o da tabela
  ...
  $chave_primaria = "codigo_cliente";
  $descricao_principal = "nome_cliente";
...
// Ordem (DESC ou ASC)
  ...
  $ordem_padrao = "DESC";
  $campo_ordenacao_padrao = "codigo_cliente";



// Identifica��o do Sistema

  $sistema_singular = "Cliente";
  $sistema_plural = "Clientes";
