<?php
  ...
  if (ISSET($_SESSION['senha_result']) && ISSET($_SESSION['login_result']))
  {
    ...
    if(verifica_usuario2($codigo_modulo, $permissao))
    {
      ...
      select_painel_edit($campos[$cont2],$campos[$cont6],$campos[$cont5],$campos[$cont7],$campos[$cont1],$sistema_exclusao,$campos[$cont10],$codigo_registro,$largura_select,$valor_atual);  
