...
<script language="javascript">
  ...
  function filtros_mostrar_select(ct,id,reg,v)
  {
   ...
   function filtros_mostrar_select_ass(ct,id,reg,v)
  {
    var nome_id = "#div_" + id;
    var aleatorio3 = Math.floor(Math.random()*100000);
    var cm = '<? echo $codigo_modulo; ?>';
    ...
    $(nome_id).html('abrindo select ...');  
    $(nome_id).load('ajax_painel_filtros_mostrar_select_ass.php?codigo_modulo=' + cm + '&cont=' + ct +  '&codigo_registro=' + reg + '&valor_atual=' + v + '&a=' + aleatorio3);
