<?php
  ...
  $nome_relatorio = "Ticket M�dio por M�s";
  ...
  $sql = " SELECT AVG(valor_pedido) as ticket, CONCAT(SUBSTRING(data_pedido,5,2),'/',SUBSTRING(data_pedido,1,4)) as mes, SUBSTRING(data_pedido,1,4) as ano ";
