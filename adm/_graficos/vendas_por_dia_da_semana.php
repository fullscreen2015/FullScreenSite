<?php
  ...
  $sql = " SELECT SUM(tabela_ec_pedidos_itens.quantidade*valor_unitario) as vendas, descricao_categoria ";
  ...
  $campos[121] = "vendas";
  $campos[122] = "Valor Vendido";
  $campos[123] = "inteiro";
  $campos[124] = "tabela_ec_pedidos_itens";
  $campos[125] = "15%";
  $campos[126] = "number";
