<?php
  ...
  $nome_relatorio = "Pareto - Vendas por Regi�o";
  ...
  $sql = " SELECT SUM(valor_pedido) as total ";
  $sql.= " FROM tabela_ec_pedidos_detalhes,tabela_ec_clientes_enderecos, tabela_estados, tabela_regioes";
  ...
  $sql.= " AND tabela_ec_clientes_enderecos.estado_cliente = tabela_estados.descricao_estado";
  $sql.= " AND tabela_estados.codigo_regiao = tabela_regioes.codigo_regiao";
  ...
  $sql = " SELECT descricao_regiao, SUM(valor_pedido) as valor ";
  $sql.= " FROM tabela_ec_pedidos_detalhes,tabela_ec_clientes_enderecos, tabela_estados, tabela_regioes";
  $sql.= " WHERE tabela_ec_pedidos_detalhes.ativo=1  ";
  $sql.= " AND  tabela_ec_clientes_enderecos.ativo=1 ";
  $sql.= " AND tabela_ec_pedidos_detalhes.codigo_endereco=tabela_ec_clientes_enderecos.codigo_endereco ";
  ...
  $sql.= " GROUP BY tabela_regioes.codigo_regiao ";
  $sql.= " ORDER BY valor DESC ";


  $campos[111] = "descricao_regiao";
  $campos[112] = "Regi�o";
  $campos[113] = "varchar";
  $campos[114] = "tabela_regioes";
  $campos[115] = "80%";
  $campos[116] = "string";
