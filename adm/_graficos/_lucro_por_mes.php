<?php
  ...
  $sql = " SELECT SUM((valor_unitario-preco_custo)*quantidade) as lucro, CONCAT(SUBSTRING(data_pedido,5,2),'/',SUBSTRING(data_pedido,1,4)) as mes, SUBSTRING(data_pedido,1,4) as ano";
