<?php
  ...
  $nome_relatorio = "Quantidade de Produtos";
  ...
  $filtro[111] = "Produtos";
  $filtro[112] = "SELECT codigo_produto, descricao_produto FROM tabela_ec_produtos_detalhes WHERE ativo=1 ORDER BY descricao_produto";
  $filtro[113] = "codigo_produto";
  $filtro[114] = "descricao_produto";
  $filtro[115] = "codigo_produto";
...
if(isset($_REQUEST[$filtro[113]]))
{
  ...
  $sql = " SELECT SUM(quantidade) as quantidade, CONCAT(SUBSTRING(data_pedido,5,2),'/',SUBSTRING(data_pedido,1,4)) as mes, SUBSTRING(data_pedido,1,4) as ano ";
  $sql.= " FROM tabela_ec_pedidos_detalhes, tabela_ec_pedidos_itens";
  $sql.= " WHERE tabela_ec_pedidos_detalhes.codigo_situacao=5";
...
?>
        ...
        chart.draw(data, {width: 900, height: 540, title: '<? echo $nome_relatorio; ?>',
