<?php
  ...
  $nome_relatorio = "Acessos do mês atual dia a dia";
  ...
  $ga->requestReportData($ga_profile_id, 'day', array('pageviews', 'visits'), 'day', null, $inicio, $fim);
...
?>
        ...
        chart.draw(data, {width: 900, height: 240, title: '<? echo $nome_relatorio; ?>',
