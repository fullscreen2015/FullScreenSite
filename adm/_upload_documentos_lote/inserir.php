<?php
  ...
  if(verifica_usuario2($codigo_modulo, $permissao))
  {
    ...
    barra("Menu Principal","../index.php","Painel","../" . $_REQUEST['s'] ,"Envio de Fotos em Lote (Formulário)","","","");  
    ...
    echo "<input type=hidden name=up_codigo_modulo value='".$codigo_modulo."'>";
    ...
    for($cont=1;$cont<=$numero_campos;$cont++)
    {
      ...
      {
        echo "<br>";
        input2($campos[$cont2],$campos[$cont1],$campos[$cont4],$tabela,$campos[$cont10]);  
      }
